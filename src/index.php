            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if ($username !== "") {
                        ...
                        Uygulamalarda ki şifrelerini ve kullanıcı adlarını barındırmak için basit ve modern bir not uygulaması, hızlıdır ve güvenlidir.<br><br>Eğer çalışmıyorsa, beni hatırla kısmını işaretlemediğin için çalışmıyor.';
                    } else {
