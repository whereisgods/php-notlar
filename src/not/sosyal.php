...
<html lang="tr">
<head>
    <title>Notlar - Sosyal medya</title>
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="container mt-5">
            <h2 class="mb-4">Sosyal medya</h2>
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="2.png" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Twitter</h5>
                            <p class="card-text">Twitter hesabına ait bilgileri görüntülemek için buraya git.</p>
                            <a href="./twitter" class="btn btn-primary">Git</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Instagram hesabına ait bilgileri görüntülemek için buraya git.</p>
                            <a href="./instagram" class="btn btn-primary">Git</a>
                        </div>
                    </div>
                </div>
            </div>
